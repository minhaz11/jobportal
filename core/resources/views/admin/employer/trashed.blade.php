...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>All trashed Employer</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">Home</a></li>
                <li class="breadcrumb-item active">trashed employers</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Trashed Employers</h3>
                    ...
                    <tbody>
                        ...
                        <td>{{$employer->address}}</td>
                          <td>
                            ...
                            <a href="{{route('admin.employer.restore',['id'=>$employer->id])}}" class="btn btn-success btn-sm"><i class="fas fa-restore"></i></a>
