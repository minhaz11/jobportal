...
@section('content')
<div class="site-blocks-cover overlay" style="background-image: url('{{asset('assets/frontend')}}/images/hero_1.jpg');"
    ...
    <div class="row">
      ...
      <div class="col-sm-6 col-md-4 col-lg-3 mb-3" data-aos="fade-up" data-aos-delay="100">
        <a href="#" class="h-100 feature-item">
          ...
          <h2>{{@$row->name}}</h2>
          <span class="counting">{{count($row->jobs)}}</span>
        </a>
      </div>
      @endforeach
    ...
    <div class="row">
      <div class="col-md-8 mb-5 mb-md-0" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="rounded border jobs-wrap">
          ...
          <a href="job-single.html" class="job-item d-block d-md-flex align-items-center  border-bottom fulltime">
            <div class="company-logo blank-logo text-center text-md-left pl-3">
              <img src="{{asset('assets/frontend')}}/images/company_logo_blank.png" alt="Image"
            ...
            <div class="job-details h-100">
              <div class="p-3 align-self-center">
                ...
                <div class="d-block d-lg-flex">
                  ...
                  <div class="mr-3"><span class="icon-room mr-1"></span> {{$row->address}}</div>
            ...
            <div class="job-category align-self-center">
              <div class="p-3">
                <span class="text-info p-2 rounded border border-info">{{ucfirst($row->type)}}</span>
              </div>
            </div>
          </a>
          @endforeach
          ...
          {{-- <a href="job-single.html" class="job-item d-block d-md-flex align-items-center freelance">
              <div class="company-logo blank-logo text-center text-md-left pl-3">
                <img src="{{asset('assets/frontend')}}/images/logo_1.png" alt="Image" class="img-fluid mx-auto">
        </div>
        <div class="job-details h-100">
          <div class="p-3 align-self-center">
        ...
        <a href="job-single.html" class="job-item d-block d-md-flex align-items-center fulltime">
          <div class="company-logo blank-logo text-center text-md-left pl-3">
            <img src="{{asset('assets/frontend')}}/images/company_logo_blank.png" alt="Image" class="img-fluid mx-auto">
          </div>
          <div class="job-details h-100">
            <div class="p-3 align-self-center">
        ...
        <a href="job-single.html" class="job-item d-block d-md-flex align-items-center partime">
          <div class="company-logo blank-logo text-center text-md-left pl-3">
            <img src="{{asset('assets/frontend')}}/images/logo_2.png" alt="Image" class="img-fluid mx-auto">
          </div>
          <div class="job-details h-100">
            <div class="p-3 align-self-center">
    ...
    <div class="col-md-4 block-16" data-aos="fade-up" data-aos-delay="200">
      ...
      <div class="nonloop-block-16 owl-carousel">
        ...
        <div class="border rounded p-4 bg-white">
          <h2 class="h5">{{$row->position}}</h2>
          <p><span class="border border-warning rounded p-1 px-2 text-warning">{{$row->type}}</span></p>
          <p>
            <span class="d-block"><span class="icon-suitcase"></span> Resto Bar</span>
            <span class="d-block"><span class="icon-room"></span> {{$row->address}}</span>
  ...
  <div class="container">
    <div class="row align-items-center">
      <div class="col-md-6 mb-5 mb-md-0">
        ...
        <div class="img-border">
          <a href="https://vimeo.com/28959265" class="popup-vimeo image-play">
            ...
            <img src="{{asset('assets/frontend')}}/images/hero_2.jpg" alt="Image" class="img-fluid rounded">
          </a>
        </div>
      ...
      <div class="col-md-5 ml-auto">
        ...
        <p class="mb-4 h5 font-italic lineheight1-5">&ldquo;Lorem ipsum dolor sit amet, consectetur adipisicing elit.
          Eaque, nisi Lorem ipsum dolor sit amet, consectetur adipisicing elit. Odit nobis magni eaque velit eum, id rem
          eveniet dolor possimus voluptas..&rdquo;</p>
...
<div class="site-blocks-cover overlay inner-page"
  style="background-image: url('{{asset('assets/frontend')}}/images/hero_1.jpg');" data-aos="fade"
  ...
  <div class="container">
    ...
    <div class="d-block d-md-flex border-bottom">
      <div class="text-center p-4 item border-right" data-aos="fade">
        ...
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Obcaecati reprehenderit explicabo quos fugit vitae
          dolorum.</p>
